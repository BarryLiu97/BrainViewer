...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self._brain_gp.setMaximumSize(QtCore.QSize(397, 98))
        ...
        self._rois_gp.setMaximumSize(QtCore.QSize(397, 16777215))
        ...
        self._roi_transparency_slider.setProperty("value", 60)
        self._roi_transparency_slider.setSliderPosition(60)
        ...
        self._info_table.setMaximumSize(QtCore.QSize(400, 16777215))
        font = QtGui.QFont()
        font.setPointSize(9)
